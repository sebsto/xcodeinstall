...
class SecretsHandlerTestBase<T: SecretsHandler> : XCTestCase {
    ...
    class override var defaultTestSuite: XCTestSuite { get {
    ...
    func testLoadAndSaveSession() async throws {
        ...
        do {
            // given
            let session = AppleSession(itcServiceKey: AppleServiceKey(authServiceUrl: "authServiceUrl", authServiceKey: "authServiceKey"), xAppleIdSessionId: "xAppleIdSessionId", scnt: "scnt")
